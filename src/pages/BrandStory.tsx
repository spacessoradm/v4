...
const BrandStory = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-blue-50">
      ...
      <div className="relative h-96 overflow-hidden bg-gradient-to-r from-teal-100 to-cyan-100 skew-y-3 transform -mt-20">
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-20 relative z-10">
        ...
        <div className="relative mb-32">
          <div className="absolute inset-0 bg-gradient-to-r from-teal-100/50 to-cyan-100/50 rounded-3xl -rotate-3 transform"></div>
        ...
        <div className="text-center mb-20">
          <div className="bg-gradient-to-r from-teal-100 to-cyan-100 p-12 rounded-3xl shadow-lg">
            <h2 className="text-4xl font-serif mb-6 text-gray-800">Ready to Create Your Magnetic Story?</h2>
            <button className="bg-gradient-to-r from-teal-400 to-cyan-400 text-white px-12 py-4 rounded-full text-lg hover:from-teal-500 hover:to-cyan-500 transition-all duration-300 shadow-lg hover:shadow-xl">
              Begin Your Journey
            </button>
          </div>
        </div>
