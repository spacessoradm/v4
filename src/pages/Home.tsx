...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-teal-100 global-font">
      {/* Hero Section */}
      <div className="relative h-[80vh] bg-gradient-to-r from-teal-200/90 to-teal-300/90">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="max-w-3xl">
            ...
            <Link
              to="/product/set-of-6"
              className="inline-block bg-teal-400 text-black px-12 py-4 rounded-full text-lg font-semibold hover:bg-teal-500 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Start Creating
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            {[{
              ...
              icon: <Star className="h-8 w-8 text-teal-400" />,
              title: "Easy to Create",
              description: "Simple upload and customization process"
            }, {
              icon: <Truck className="h-8 w-8 text-teal-400" />,
              title: "Fast Shipping",
              ...
              >
                <div className="flex items-center justify-center h-16 w-16 rounded-full bg-teal-100 mx-auto mb-6">
                  {feature.icon}
                </div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="bg-teal-400 text-black px-6 py-2 rounded-full text-sm font-medium group-hover:bg-teal-500 transition-all duration-300">
                      Order Now
                    </span>
                  </div>
                </div>
