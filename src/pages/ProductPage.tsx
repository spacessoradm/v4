...
export default function ProductPage() {
  ...
  // Initialize uploaded images with existing images if in edit mode
  useEffect(() => {
  ...
  if (!product) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-gradient-to-b from-teal-50 to-emerald-50 global-font">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            className="w-full bg-tiffany-500 text-white py-3 px-6 rounded-md hover:bg-tiffany-600 transition-colors"
          >
            ...
            .map((relatedProduct) => (
              ...
              >
                ...
                <button
                  ...
                  className="mt-4 w-full bg-tiffany-500 text-white py-2 px-4 rounded-md hover:bg-tiffany-600 transition-colors"
                >
                  View Product
                </button>
              </div>
